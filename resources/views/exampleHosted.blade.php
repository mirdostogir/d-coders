     ...
     @endphp
                ...
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        ...
                        class="itemImg" width="100">
                    </div>
                    <p> <input type="text" type="number" id="number" value="{{$product['quantity']}}"  class="qty" placeholder="{{$product['quantity']}}"/>
                         x ${{$product['price']}}</p>
                </li>
                ...
                <ul>
                  ...
                  <li class="totalRow"><span class="label">Subtotal</span><span class="value">${{$total}}</span></li>
                      ...
                      <li class="totalRow"><span class="label">Shipping</span><span class="value">$5.00</span></li>
                        ...
                        <li class="totalRow"><a href="{{route('cart')}}" class="btn continue">Checkout</a></li>
                </ul>
              </div>
        </div>
        @endif
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control"name="customer_address2" id="address2" placeholder="Apartment or suite">
                </div>
                ...
                <div class="custom-control custom-checkbox">
                    ...
                    <input type="hidden" value="{{$total+$Shipping}}" name="amount" id="total_amount" required/>

  ...
  <div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
      <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        ...
        <h3 class="page-title">Create A New Product</h3>
      </div>
    </div>
    <!-- End Page Header -->
    <!-- Small Stats Blocks -->
        ...
        @csrf
         ...
         <div class="control-group">
           <div class="form-group floating-label-form-group controls">
             ...
             <textarea rows="5" class="form-control" placeholder="Description"  required name="description"></textarea>
         ...
         <div class="control-group">
           ...
           <span class="input-group-text">$</span>
             ...
             <input rows="5" class="form-control" placeholder="price"  required name="price"></input>
             </div>
           </div>
         </div>
          <div class="control-group">

        ...
        <tr>
            ...
            <td>
                <form action="{{ route('categories.destroy',$categorie->id) }}" method="POST">
                    ...
                    <a class="edit" title="Edit"   style="color: #FFC107;" data-toggle="tooltip " href="{{ route('categories.edit',$categorie->id) }}"><i class="material-icons">&#xE254;</i></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="col-lg-15 margin-tb" style=" align-items:center;">
            <div class="pull-left" >
                <h5 style="text-align:center;">Create Categorie</h5>
            </div>
            ...
            @csrf
             ...
             <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control"  name="detail" placeholder="Detail"></input>
                        <br>
                        <div class="form-group">

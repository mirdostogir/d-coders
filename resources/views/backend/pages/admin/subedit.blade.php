  ...
  <div class="card-body">
   <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h4 style="left:10px;">Edit Sub-Categorie</h4>
            </div>
   ...
   <div class="row">
    ...
    <form action="{{url('updatesubcategories/'.$sub_categories->id)}}" method="Post" enctype="multipart/form-data">
             ...
             <div class="row">
                <div class="col-xs-8 col-sm-8 col-md-8">
                    <div class="form-group">
                        <strong>Name:</strong>
                        <input type="text" name="name" value="{{ $sub_categories->name }}" class="form-control" placeholder="Name">
                    </div>
                </div>
            ...
            <select class="form-control" name="categorie_id">
              @foreach($categories as $row)
            	<option value="{{ $row->id }}"  <?php if($row->id == $sub_categories->categorie_id) echo "selected"; ?> >{{ $row->name }}</option>
            	@endforeach
            </select>
           </div>

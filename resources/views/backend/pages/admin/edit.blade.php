  ...
  <div class="main-navbar sticky-top bg-white">
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h4 style="left:10px;">Edit Categorie</h4>
            </div>
    ...
    @endif
       ...
       <li class="list-group-item p-3">
        <div class="row">
             <div class="col">
    <form action="{{ url('backend/pages/admin/'.$categories->id) }}" method="Post" enctype="multipart/form-data">
             ...
             <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="detail" value="{{ $categories->detail }}" class="form-control" placeholder="Detail">

...
<head>
  ...
  <title>Catagoty & Subcatagory</title>
...
<div class="row">
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h5 style="left:10px;">Sub-Categories List</h5>
            </div>
...
<thead class="thead-dark">
        ...
        <tr>
            ...
            <td>{{ $sub_categorie->categories->name }}</td>
           
            <td>
                <form action="{{ route('subcategories.destroy',$sub_categorie->id) }}" method="POST">
   
                
                 
                <a class="edit" title="Edit"   style="color: #FFC107;" data-toggle="tooltip " href="{{ route('subcategories.edit',$sub_categorie->id) }}"><i class="material-icons">&#xE254;</i></a>
                    ...
                    <button class="delete" style="color: #E34724;"type="submit" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></button>
                </form>
            </td>
        </tr>
        @endforeach
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="col-lg-15 margin-tb" style=" align-items:center;">
            <div class="pull-left" >
                <h5 style="text-align:center;">Create Sub Categorie</h5>
            </div>
